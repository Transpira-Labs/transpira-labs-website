        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-8 text-foreground/80 leading-relaxed">
            ...
            <section>
              ...
              <p>
                Depending on your jurisdiction, you may have the right to access, correct, delete, or restrict the processing of your personal information. To exercise these rights, please contact us at hello@classhopper.tech.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                <a href="mailto:hello@classhopper.tech" className="text-foreground hover:underline">
