        ...
        <article className="px-6 pt-36 pb-24">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center justify-between gap-4">
              ...
              <a href="mailto:team@transpiralabs.com" className="rounded-full px-5 py-2.5 bg-primary text-primary-foreground text-sm hover:bg-primary/90 transition">
                Request Access
              </a>
            </div>
          </div>
