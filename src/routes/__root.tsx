...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Transpira is building Manifest: one permissions-aware index across all of your supply-chain systems. Plain-language questions, answers cited to the source record." },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Transpira Labs" },
      { name: "twitter:title", content: "Transpira Labs" },
      { property: "og:description", content: "Transpira is building Manifest: one permissions-aware index across all of your supply-chain systems. Plain-language questions, answers cited to the source record." },
      { name: "twitter:description", content: "Transpira is building Manifest: one permissions-aware index across all of your supply-chain systems. Plain-language questions, answers cited to the source record." },
